...
### To run, use for example "rosrun package bag_reader.py -b test.bag -t /temperature -o temperature.csv"
### -b for specifying bag file, -t for topic and -o for output file
